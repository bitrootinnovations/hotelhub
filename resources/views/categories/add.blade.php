    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h6>Create a new food category</h6>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="category_name" class="form-control" value="{{ old('category_name') }}" placeholder="e.g. Veg, Non-Veg, Starters" required>
                        </div>
                    </div>
                    @if(!$isClientUser)
                    <div class="col-sm-6 col-12">
