...
<div class="content">
    ...
    @if($role->role_id == 1)
        <div class="alert alert-info mb-3">
            ...
            The <strong>Admin</strong> role is protected. Role name cannot be changed.
        </div>
    @endif

    <form method="POST" action="{{ $id }}" class="add-product-form">
        @csrf
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="status_id"
                                            {{ $role->role_id == 1 ? 'disabled' : '' }}>
                                            <option value="1" {{ old('status_id', $role->status_id) == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ old('status_id', $role->status_id) == 0 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @if($role->role_id == 1)
