    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Edit Staff Member</h4>
                <h6>Update staff details below</h6>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('client.employees.update', $employee->id) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                            value="{{ old('phone', $employee->phone) }}" maxlength="20" required>
        ...
        <div class="d-flex align-items-center justify-content-end mb-4">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="ti ti-device-floppy me-1"></i>Update Staff Member
            </button>
        </div>
    </form>
</div>
