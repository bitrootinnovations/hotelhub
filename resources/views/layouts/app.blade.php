...
<head>
	...
	<!-- Color Picker Css -->
	<link rel="stylesheet" href="{{ $base_url }}/assets/plugins/@simonwep/pickr/themes/nano.min.css">
...
<body>
	...
	<!-- Color Picker JS -->
	<script src="{{ $base_url }}/assets/plugins/@simonwep/pickr/pickr.es5.min.js"></script>
