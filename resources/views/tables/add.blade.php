...
<div class="content">
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4 class="fw-bold">Add Table</h4>
                <h6>Register a new restaurant table</h6>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('tables.store') }}">
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="seat_label" class="form-control" value="{{ old('seat_label') }}" placeholder="e.g. T1, T2, A, B, 1, 2" required>
                        </div>
                    </div>
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
                            ...
                            <input type="number" name="capacity" class="form-control" value="{{ old('capacity') }}" placeholder="e.g. 4" min="1">
                        </div>
                    </div>
                    <div class="col-sm-6 col-12">
                        <div class="mb-3">
        ...
        <div class="d-flex justify-content-end mb-4">
            ...
            <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i>Save Table</button>
        </div>
    </form>
</div>
...
function filterTableTypes(clientId) {
    ...
    if (filtered.length === 0) {
        select.innerHTML = '<option value="">No table types for this client</option>';
        return;
    }
    ...
    filtered.forEach(t => {
        ...
        if (oldTypeId && oldTypeId == t.table_type_id) opt.selected = true;
...
if (oldClientId) filterTableTypes(oldClientId);
</script>
@endsection
