...
<div class="content">
    ...
    <form method="POST" action="{{ url('employees/' . $id) }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="accordion-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email_id" class="form-control" value="{{ old('email_id', $employee->email_id) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Contact Number <span class="text-danger">*</span></label>
                                <input type="text" name="contact_number" class="form-control" value="{{ old('contact_number', $employee->contact_number) }}" maxlength="15" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="designation" class="form-control" value="{{ old('designation', $employee->designation) }}" maxlength="100">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Department</label>
                                <input type="text" name="department" class="form-control" value="{{ old('department', $employee->department) }}" maxlength="100">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Status</label>
                                <select name="status_id" class="form-select">
                                    <option value="1" {{ old('status_id', $employee->status_id) == 1 ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('status_id', $employee->status_id) == 0 ? 'selected' : '' }}>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-body">
                        @if($employee->profile_image)
                            <div class="mb-3">
                                ...
                                <img src="{{ $base_url }}/storage/app/public/{{ $employee->profile_image }}"
                                    class="img-thumbnail" style="max-height:150px;" alt="Profile">
                            </div>
                        @endif
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                <label class="form-label">{{ $employee->profile_image ? 'Replace Photo' : 'Upload Photo' }}</label>
