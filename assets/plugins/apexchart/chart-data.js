...
if($('#customer-chart').length > 0 ){
  ...
  if ($('#sales-daychart').length > 0) {
    var sColStacked = {
      ...
      series: [{
        name: 'Orders',
        data: (window.dashboardChartOrders || [18, 20, 10, 18, 25, 18, 10, 20, 40, 8, 30, 20])
      }, {
        name: 'Revenue',
        data: (window.dashboardChartRevenue || [40, 30, 30, 50, 40, 50, 30, 30, 50, 30, 40, 30])
      }],
      xaxis: {
        categories: (window.dashboardChartLabels || ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']),
        labels: {
          style: {
            colors: '#6B7280', 
            fontSize: '13px',
